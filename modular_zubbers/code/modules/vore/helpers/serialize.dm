...
*/
/datum/proc/datum_json_serialize()
...
*/
/datum/proc/datum_json_deserialize(var/list/data)
	return
...
/atom/datum_json_deserialize(var/list/data)
	for(var/thing in vars_to_save())
		if(thing in data)
...
/proc/object_to_json(var/atom/movable/thing)
	return json_encode(thing.datum_json_serialize())
...
/proc/list_to_object(var/list/data, var/loc)
	...
	thing.datum_json_deserialize(data)
	return thing
